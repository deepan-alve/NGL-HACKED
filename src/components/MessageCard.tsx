...
export function MessageCard({ message, onMessageChange, onRandomMessage, imageUrl }: MessageCardProps) {
  return (
    <div className="bg-white rounded-[32px] shadow-lg overflow-hidden w-full">
      <div className="px-4 py-3 flex items-center gap-3 border-b border-gray-100">
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-[15px] font-semibold text-gray-900">@deepan.alve</h1>
          <p className="text-[13px] text-gray-600">send me anonymous messages!</p>
        </div>
      </div>
